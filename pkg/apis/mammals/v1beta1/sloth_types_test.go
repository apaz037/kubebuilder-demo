...
import (
	...
	. "kubebuilder-demo/pkg/apis/mammals/v1beta1"
	. "kubebuilder-demo/pkg/client/clientset/versioned/typed/mammals/v1beta1"
)

// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the Sloth resource tests

var _ = Describe("Sloth", func() {
	var instance Sloth
	var expected Sloth
	var client SlothInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.MammalsV1beta1().Sloths("default")
