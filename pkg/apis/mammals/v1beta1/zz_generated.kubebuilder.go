...
var SchemeGroupVersion = schema.GroupVersion{Group: "mammals.chill.af", Version: "v1beta1"}
...
type SlothList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Sloth `json:"items"`
}
...
var (
	...
	SlothCRD = v1beta1.CustomResourceDefinition{
